...
class CleanDetailHistoryPage extends StatefulWidget {
  const CleanDetailHistoryPage({super.key, required this.cleanModel});
  final CleanModel cleanModel;
  @override
  State<CleanDetailHistoryPage> createState() => _CleanDetailHistoryPageState();
}
                        ...
                        children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        '${widget.cleanModel.cleanId!.address}'),
                                  ],
                                ),
                              )
                            ],
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                  child: Text(widget.cleanModel.cleanId!.note ==
                                          ""
                                      ? '...'
                                      : "${widget.cleanModel.cleanId!.note}"))
                            ],
                          ),
                          const SizedBox(
                            height: 8,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                            ...
                            '${AppConstant.oCcy.format(widget.cleanModel.cleanId!.price)} VND',
                            style: const TextStyle(
                              fontWeight: FontWeight.bold,
                            )),
                      ],
